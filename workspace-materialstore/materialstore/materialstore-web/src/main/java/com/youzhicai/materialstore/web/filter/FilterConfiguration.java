 ...
 * @Package com.youzhicai.materialstore.web.filter
...
//    @Bean
//    public FilterRegistrationBean checkSessionFilter() {
//        return filterRegistrationBean("checkSessionFilter", new CheckSessionFilter(), 1, Arrays.asList("/*"));
//    }
