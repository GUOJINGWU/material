...
public class HttpPostUploadUtil {
    ...
    public HttpPostUploadUtil(String url) throws Exception {
     ...
     * @throws Exception
     */
    public String send(String cookies) throws Exception {
        initConnection(cookies);
        conn.connect();
     ...
     * @throws Exception
     */
    private void initConnection(String cookies) throws Exception {
        ...
        if (null != cookies) {
            conn.setRequestProperty("Cookie", cookies);// 设置Cookies
        }
    }
...
//          outputStream.writeUTF("Content-Disposition: form-data; name=\"" + name + "\"; filename=\"" + value.getName() + "\"\r\n");
//          outputStream.writeBytes("Content-Disposition: form-data; name=\"" + name + "\"; filename=\"" + value.getName() + "\"\r\n");
