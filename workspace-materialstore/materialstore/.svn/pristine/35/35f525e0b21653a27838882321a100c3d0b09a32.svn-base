 ...
 * @Package com.youzhicai.materialstore.business.filter
...
import com.youzhicai.materialstore.business.transfer.DataTransfer;
import com.youzhicai.materialstore.business.transfer.TransferType;
...
public class DataTransferFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            if (transfer(httpRequest)) {
                Throwable cause;
                if ((cause = e.getCause()) instanceof BusinessException) {
                    ciphertext = mapper.writeValueAsString(
                            new DataTransfer<Object>(((BusinessException) cause).getCode(), ((BusinessException) cause).getMsg()));
                    e = null;
                } else {
                    ciphertext = mapper.writeValueAsString(new DataTransfer<Object>(TransferType.ERROR.getCode(), TransferType.ERROR.getMsg()));
                }
            }
